...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 280085748;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<void> crateApiCommandsPacketFromEngineGetDestination(
      {required PacketFromEngine that});

  List<String> crateApiSimpleGetMidiDevices();
  ...
  void crateApiSimpleSetMidiInputPort({required String name});

  void crateApiSimpleSetParameter(
      {required ParameterID id, required double value});

  Future<ApplicationState> crateApiUiApplicationStateNew();
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  List<String> crateApiSimpleGetMidiDevices() {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiSimpleGetMidiDevicesConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiSimpleGetMidiDevicesConstMeta =>
      const TaskConstMeta(
        debugName: "get_midi_devices",
        argNames: [],
      );
  ...
  void crateApiSimpleSetMidiInputPort({required String name}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiSimpleSetMidiInputPortConstMeta,
      argValues: [name],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiSimpleSetMidiInputPortConstMeta =>
      const TaskConstMeta(
        debugName: "set_midi_input_port",
        argNames: ["name"],
      );
  ...
  void crateApiSimpleSetParameter(
    ...
    return handler.executeSync(SyncTask(
      callFfi: () {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_parameter_id(id, serializer);
      ...
      constMeta: kCrateApiSimpleSetParameterConstMeta,
      argValues: [id, value],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiSimpleSetParameterConstMeta => const TaskConstMeta(
        debugName: "set_parameter",
        argNames: ["id", "value"],
      );
  ...
  Future<ApplicationState> crateApiUiApplicationStateNew() {
    return handler.executeNormal(NormalTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_application_state,
        decodeErrorData: null,
      ),
      constMeta: kCrateApiUiApplicationStateNewConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiUiApplicationStateNewConstMeta =>
      const TaskConstMeta(
        debugName: "application_state_new",
        argNames: [],
      );
  ...
  @protected
  ApplicationState dco_decode_application_state(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 1)
      throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
    return ApplicationState(
      midiDevices: dco_decode_list_String(arr[0]),
    );
  }
  ...
  PacketFromEngine dco_decode_packet_from_engine(dynamic raw) {
    ...
    switch (raw[0]) {
      ...
      case 3:
        return PacketFromEngine_MidiPorts(
  ...
  ParameterID dco_decode_parameter_id(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return ParameterID.values[raw as int];
  }
  ...
  @protected
  ApplicationState sse_decode_application_state(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_midiDevices = sse_decode_list_String(deserializer);
    return ApplicationState(midiDevices: var_midiDevices);
  }
  ...
  PacketFromEngine sse_decode_packet_from_engine(SseDeserializer deserializer) {
    ...
    switch (tag_) {
      ...
      case 3:
        ...
        return PacketFromEngine_MidiPorts(var_field0);
      default:
        throw UnimplementedError('');
    }
  }
  ...
  ParameterID sse_decode_parameter_id(SseDeserializer deserializer) {
    ...
    return ParameterID.values[inner];
  }
  ...
  @protected
  void sse_encode_application_state(
      ApplicationState self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_list_String(self.midiDevices, serializer);
  }
  ...
  void sse_encode_packet_from_engine(
    ...
    switch (self) {
      ...
      case PacketFromEngine_MidiPorts(field0: final field0):
