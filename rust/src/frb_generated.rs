...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 280085748;
...
fn wire__crate__api__simple__get_midi_devices_impl(
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            deserializer.end();
            transform_result_sse::<_, ()>((move || {
                let output_ok = Result::<_, ()>::Ok(crate::api::simple::get_midi_devices())?;
                Ok(output_ok)
            })())
        },
    )
...
fn wire__crate__api__ui__application_state_new_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "application_state_new",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Result::<_, ()>::Ok(crate::api::ui::ApplicationState::new())?;
                    Ok(output_ok)
                })())
            }
        },
...
impl SseDecode for crate::api::ui::ApplicationState {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut var_midiDevices = <Vec<String>>::sse_decode(deserializer);
        return crate::api::ui::ApplicationState {
            midi_devices: var_midiDevices,
        };
    }
}
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        11 => wire__crate__api__ui__application_state_new_impl(port, ptr, rust_vec_len, data_len),
        12 => wire__crate__api__ui__run_handler_thread_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        3 => wire__crate__api__simple__get_midi_devices_impl(ptr, rust_vec_len, data_len),
        5 => wire__crate__api__simple__note_off_impl(ptr, rust_vec_len, data_len),
        6 => wire__crate__api__simple__note_on_impl(ptr, rust_vec_len, data_len),
        7 => wire__crate__api__simple__play_impl(ptr, rust_vec_len, data_len),
        8 => wire__crate__api__simple__set_midi_input_port_impl(ptr, rust_vec_len, data_len),
        9 => wire__crate__api__simple__set_parameter_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
impl flutter_rust_bridge::IntoDart for crate::api::ui::ApplicationState {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [self.midi_devices.into_into_dart().into_dart()].into_dart()
    }
}
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::ui::ApplicationState
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::ui::ApplicationState>
    for crate::api::ui::ApplicationState
{
    fn into_into_dart(self) -> crate::api::ui::ApplicationState {
        self
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
...
impl SseEncode for crate::api::ui::ApplicationState {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <Vec<String>>::sse_encode(self.midi_devices, serializer);
    }
}
